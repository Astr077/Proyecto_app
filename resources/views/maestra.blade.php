...
<head>
    ...
    <title>@yield("titulo") -Proyecto Final Magali</title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
    <a class="navbar-brand" target="_blank" href="">Proyecto Final Magali</a>
...
<footer class="px-2 py-2 fixed-bottom bg-dark">    <span class="text-muted">Punto de venta en Laravel
        </a>
    </span>
</footer>
</body>
